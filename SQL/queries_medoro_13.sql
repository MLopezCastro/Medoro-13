...
-- Ejecutar (después de tener creada MED_V5E_Eventos_MAT)
...
--Usá la ventana según el “atraso real”
--Si pasaron más de 7 días, correr los SP con un @DiasVentana mayor para cubrir el bache. 
--Por ejemplo, si estuvieron 14 días sin refresh:

EXEC dbo.RefrescarV5_Incremental  @DiasVentana = 14;  -- BLOQUES
EXEC dbo.RefrescarV5E_Incremental @DiasVentana = 14;  -- EVENTOS
